...
composer create-project --no-install --repository-url=https://repo.magento.com/ magento/project-community-edition app-2
composer --working-dir=app-2 --no-install --no-interaction require \
...
composer --working-dir=app-2 install
